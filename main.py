...
background_image = pygame.transform.scale(pygame.image.load("premium_photo-1674834298045-e405bc99076b.jpg"), (SCREEN_WIDTH, SCREEN_HEIGHT))
...
pygame.display.set_caption("Sprites and Custom event")
...
while running:
    ...
    if won:
        win_text = font.render("You Win :)", True, pygame.Color('dark green'))
